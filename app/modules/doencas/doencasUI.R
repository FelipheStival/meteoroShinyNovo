      ...
      tabItem(tabName = "graficosDoenca",
              ...
              column(
                ...
                tabBox(
                  ...
                  tabPanel(
                    'Grafico Geral',
                    plotOutput('graficoDoencasPlot2', width = '100%', height = '80vh') %>% withSpinner(color = "#0dc5c1")
                  ),
                  tabPanel(
                    'Grafico local',
                    plotOutput('graficoDoencasPlot1', width = '100%', height = '80vh') %>% withSpinner(color = "#0dc5c1")
                  )
                )
       ))
    ))
